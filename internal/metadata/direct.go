...
func GetFileMetaData(fsys fs.FS, name string, localTZ *time.Location) (*Metadata, error) {
...
func GetFromReader(rd io.Reader, ext string, localTZ *time.Location) (*Metadata, error) {
	r := newSliceReader(rd)
	meta := Metadata{}
	var err error
