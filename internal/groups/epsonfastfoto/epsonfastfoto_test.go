...
func TestGroup(t *testing.T) {
	...
	testAssets := []*assets.Asset{
		...
		mockAsset(ic, "1992-xx-xx - Easter_Arizona (FF-680W-1200-PR) - 0069.jpg", baseTime.Add(2600*time.Millisecond)),
		mockAsset(ic, "1992-xx-xx - Easter_Arizona (FF-680W-1200-PR) - 0069_a.jpg", baseTime.Add(2800*time.Millisecond)),
		mockAsset(ic, "1992-xx-xx - Easter_Arizona (FF-680W-1200-PR) - 0069_b.jpg", baseTime.Add(3000*time.Millisecond)),
