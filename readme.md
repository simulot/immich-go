...
| --into-album            |                                       | Specify an album to import all files into, flag can be used multiple times in same command                                                                                                                                     |
| --into-albums            |                                      | Specify multiple albums to import all files into, group albums using this structure 'example1,example2'                                                                                                                                     |
