...
| `tag-with-session`                   | Tag uploaded assets according to the format immich-go/YYYY-MM-DD/HH-MI-SS | `FALSE` |
| `tag-with-path`                      | Hierarchically tag uploaded assets using path to assets (does not include root directory) | `FALSE` |
