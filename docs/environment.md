...
| `IMMICH_GO_ON_ERRORS` | `--on-errors` | What to do when an error occurs (stop, continue, accept N errors at max) |
...
| `IMMICH_GO_ARCHIVE_FROM_ICLOUD_BAN_FILE` | `--ban-file` | Exclude a file based on a pattern (case-insensitive). Can be specified multiple times. |
| `IMMICH_GO_ARCHIVE_FROM_ICLOUD_DATE_FROM_NAME` | `--date-from-name` | Use the date from the filename if the date isn't available in the metadata (Only for jpg, mp4, heic, dng, cr2, cr3, arw, raf, nef, mov) |
| `IMMICH_GO_ARCHIVE_FROM_ICLOUD_DATE_RANGE` | `--date-range` | Only import photos taken within the specified date range |
...
| `IMMICH_GO_ARCHIVE_FROM_ICLOUD_FOLDER_AS_ALBUM` | `--folder-as-album` | Import all files in albums defined by the folder structure. Can be set to 'FOLDER' to use the folder name as the album name, or 'PATH' to use the full path as the album name |
| `IMMICH_GO_ARCHIVE_FROM_ICLOUD_FOLDER_AS_TAGS` | `--folder-as-tags` | Use the folder structure as tags, (ex: the file  holiday/summer 2024/file.jpg will have the tag holiday/summer 2024) |
| `IMMICH_GO_ARCHIVE_FROM_ICLOUD_IGNORE_SIDECAR_FILES` | `--ignore-sidecar-files` | Don't upload sidecar with the photo. |
...
| `IMMICH_GO_ARCHIVE_FROM_ICLOUD_MEMORIES` | `--memories` | Import icloud memories as albums (default: false) |
| `IMMICH_GO_ARCHIVE_FROM_ICLOUD_RECURSIVE` | `--recursive` | Explore the folder and all its sub-folders |
...
| `IMMICH_GO_ARCHIVE_FROM_PICASA_ALBUM_PICASA` | `--album-picasa` | Use Picasa album name found in .picasa.ini file (default: false) |
| `IMMICH_GO_ARCHIVE_FROM_PICASA_BAN_FILE` | `--ban-file` | Exclude a file based on a pattern (case-insensitive). Can be specified multiple times. |
| `IMMICH_GO_ARCHIVE_FROM_PICASA_DATE_FROM_NAME` | `--date-from-name` | Use the date from the filename if the date isn't available in the metadata (Only for jpg, mp4, heic, dng, cr2, cr3, arw, raf, nef, mov) |
| `IMMICH_GO_ARCHIVE_FROM_PICASA_DATE_RANGE` | `--date-range` | Only import photos taken within the specified date range |
...
| `IMMICH_GO_ARCHIVE_FROM_PICASA_FOLDER_AS_ALBUM` | `--folder-as-album` | Import all files in albums defined by the folder structure. Can be set to 'FOLDER' to use the folder name as the album name, or 'PATH' to use the full path as the album name |
| `IMMICH_GO_ARCHIVE_FROM_PICASA_FOLDER_AS_TAGS` | `--folder-as-tags` | Use the folder structure as tags, (ex: the file  holiday/summer 2024/file.jpg will have the tag holiday/summer 2024) |
| `IMMICH_GO_ARCHIVE_FROM_PICASA_IGNORE_SIDECAR_FILES` | `--ignore-sidecar-files` | Don't upload sidecar with the photo. |
...
| `IMMICH_GO_ARCHIVE_FROM_PICASA_RECURSIVE` | `--recursive` | Explore the folder and all its sub-folders |
...
| `IMMICH_GO_UPLOAD_FROM_IMMICH_FROM_DEVICE_UUID` | `--from-device-uuid` | Set a device UUID |
| `IMMICH_GO_UPLOAD_FROM_IMMICH_FROM_DRY_RUN` | `--from-dry-run` | Simulate all actions |
...
| `IMMICH_GO_UPLOAD_FROM_IMMICH_FROM_PAUSE_IMMICH_JOBS` | `--from-pause-immich-jobs` | Pause Immich background jobs during upload operations |
