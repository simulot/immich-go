...
func (ic *ImmichClient) callSearchMetadata(ctx context.Context, req searchMetadataBody, filter func(context.Context, *Asset) error) error {
	req.setPage(1)
	for {
...
func (ic *ImmichClient) GetAllAssets(ctx context.Context) ([]*Asset, error) {
	...
	err := ic.callSearchMetadata(ctx, &req, func(ctx context.Context, asset *Asset) error {
...
func (ic *ImmichClient) GetAllAssetsWithFilter(ctx context.Context, filter func(context.Context, *Asset) error) error {
	req := searchMetadataGetAllBody{Page: 1, WithExif: true, IsVisible: true}
